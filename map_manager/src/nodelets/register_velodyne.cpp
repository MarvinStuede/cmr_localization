...
#include "nodelets/register_velodyne.h"
...
/*bool RegisterVelodyne::get_velodyne_transform()
{
    //transform listener
    tf::TransformListener listener;

    std::string targetFrameID = velo_frame_;
